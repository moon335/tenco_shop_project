			...
			<div id="inputBox">
				<form action="/user/login" method="post">
					<div class="input-form-box">
						<span>아이디 </span><input type="text" class="form-control" placeholder="예)green@green.kr" id="userId" name="userId" value="aaa@naver.com">
					</div>
					<div class="input-form-box">
						<span>비밀번호 </span><input type="password" class="form-control" id="password" name="password" value="1234">
					</div>
