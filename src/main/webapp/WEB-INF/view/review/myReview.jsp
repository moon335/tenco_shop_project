	...
	<div class="my--review--title">
		<c:choose>
			<c:when test="${principal.image != null}">
				<span class="myReview--img--wrap"><a href="#"><img src=" <c:url value="/static/images/uploads/${principal.image}"/>"></a></span>
				<span class="myReview--username--wrap"><a href="#">${principal.username}</a></span>
			</c:when>
			<c:otherwise>
				<span class="myReview--img--wrap"><a href="#"><img src="/static/images/myinfo.png"></a></span>
				<span class="myReview--username--wrap"><a href="#">${principal.username}</a></span>
			</c:otherwise>
		</c:choose>
	</div>
